...
namespace Patient_Record_Management_System
{
    public partial class Manage_Medicine : Form
    {
        ...
        private void TextBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            bs.Filter = string.Format("CONVERT(M_Id,System.String) like '{0}%' OR Name like '{0}%' OR Company like '{0}%' OR CONVERT(Manufacturing-Date,System.String) like '{0}%' OR CONVERT(Expired-Date,System.String) like '{0}%' OR CONVERT(Price,System.String) like '{0}%' OR CONVERT(Unit,System.String) like '{0}%'", textBox1.Text.ToString()); ;
